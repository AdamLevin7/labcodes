...
|      Find indexes where occurs in the list
 |document_fxn.py|[fxn_pos_list=[iforiinrange(len(info_list))if''ininfo_list[i]]](#function-fxn_pos_list=[iforiinrange(len(info_list))if''ininfo_list[i]])| 
|         fxn_desc = fxn_desc.replace("", "")
 |document_fxn.py|[fxn_name_2=fxn_name_1.replace("","")](#function-fxn_name_2=fxn_name_1.replace("",""))| 
...
|     	brief description here (1 line)
 |document_fxn.py|[table_of_contents](#function-table_of_contents)| 
| 	Creates series of documentation for functions in a repository
