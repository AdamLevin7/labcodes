...
%     ay = Mx' / Fz Y-Coordinate of force application point (COP)
    ...
    ForceTable = table(ForceDataP.FP1_x,ForceDataP.FP1_y,ForceDataP.FP1_z,...
        ForceDataP.Ax1,ForceDataP.Ay1,...
        ForceDataP.FP2_x,ForceDataP.FP2_y,ForceDataP.FP2_z,...
        ForceDataP.Ax2,ForceDataP.Ay2);

    ForceTable.Properties.VariableNames = {'FP1_x' 'FP1_y' 'FP1_z' 'FP1_ax' 'FP1_ay' 'FP2_x' 'FP2_y' 'FP2_z', 'FP2_ax', 'FP2_ay'};
